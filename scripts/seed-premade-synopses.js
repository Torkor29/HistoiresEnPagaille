// Remplit la table PremadeSynopsis avec 2 synopsis par thème.
// Utilise la base SQLite locale configurée dans prisma/schema.prisma.
    ...
    chapters: [
      {
        ...
        scenes: [
          {
            title: 'Une idée qui brille',
            summary: `${lieuIntro}, Léo imagine une aventure extraordinaire et décide de se lancer, malgré les petits doutes qu'il ressent.`,
          },
          {
            title: 'Préparatifs et promesses',
            summary:
              "Avec l'aide de ses proches, Léo prépare tout ce dont il a besoin et promet de faire preuve de courage et de gentillesse.",
          },
        ],
      },
      {
        ...
        scenes: [
          {
            title: 'Un obstacle inattendu',
            summary:
              "Un obstacle apparaît sur la route (un danger léger mais impressionnant) et Léo doit réfléchir plutôt que foncer tête baissée.",
          },
          {
            title: 'De nouveaux alliés',
            summary:
              'Léo rencontre un ou plusieurs nouveaux amis liés au thème qui l’aident avec leurs idées et leurs talents.',
          },
        ],
      },
      {
        ...
        scenes: [
          {
            title: 'Un plan malin',
            summary:
              "En combinant le courage de Léo et les idées de ses amis, ils trouvent une solution astucieuse pour atteindre leur objectif.",
          },
          {
            title: 'Retour à la maison',
            summary:
              "Léo rentre chez lui fier de lui, plus confiant et heureux d'avoir partagé cette aventure avec ses nouveaux amis.",
          },
        ],
      },
    ],
...
async function main() {
  console.log('Suppression des anciens synopsis préfaits…');
  await prisma.premadeSynopsis.deleteMany({});
    ...
    for (let i = 0; i < list.length; i++) {
      await prisma.premadeSynopsis.create({
        data: {
          ...
          icon: theme.icon,
          synopsis: JSON.stringify(list[i]),
          sortOrder: i,
        },
      });
      created += 1;
  ...
  console.log(`Synopses créés : ${created} (2 par thème).`);
}
